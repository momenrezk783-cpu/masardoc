...
PROCEDURES_DATABASE: List[Dict[str, Any]] = [
    {
        ...
        "overview_ar": "الدليل الإجرائي الميداني لاستخراج شهادات الميلاد، الوفاة، الزواج، الطلاق، ومكلفات الأطيان من الدفاتر الورقية التاريخية المودعة بدار المحفوظات منذ عهد محمد علي وحتى النصف الثاني من القرن العشرين، والتي لم تسجل بعد بالمنظومة الرقمية للأحوال المدنية.",
        "overview_en": "End-to-end procedural guide for searching and retrieving pre-digital paper civil registers, birth/death records, and historical tax ledgers (Mokallafat) preserved at the Citadel National Archives.",
        "recommended_poa_text": "يوكل في تمثيلي أمام مصلحة دار المحفوظات العمومية بقلعة صلاح الدين وفروعها، وله حق تقديم طلبات البحث والاستخراج في الدفاتر الورقية التاريخية وسجلات المواليد والوفيات وسجلات المكلفات والعوائد، والتوقيع على نماذج البحث، وسداد الرسوم، واستلام المستخرجات الرسمية وشهادات سلبية القيد المختومة بشعار الجمهورية.",
        "steps": [
            {
                "step_number": 1,
                ...
                "description_ar": "تجميع البيانات الأساسية: الاسم الرباعي، اسم الأم، المحافظة التاريخية، المركز أو القسم، الناحية أو الشياخة، والسنة التقريبية للواقعة (بهامش خطأ لا يتعدى سنتين إلى ثلاث سنوات لتسريع عمل الكاتب الميداني).",
                ...
                "poa_requirements": "يجب أن ينص التوكيل صراحة على 'التعامل مع دار المحفوظات والاطلاع واستخراج القيود والمكلفات'.",
                "estimated_duration": "يوم واحد",
                "official_fees": "بدون رسوم حكومية في هذه المرحلة",
                "critical_tips": [
                    "تأكد من معرفة التقسيم الإداري القديم للقرية أو الحي، حيث تغيرت تبعية عدة مراكز تاريخياً بين الجيزة والقاهرة والقليوبية."
                ]
            },
            {
                "step_number": 2,
                ...
                "description_ar": "شراء الاستمارة المخصصة للبحث (طلب استخراج قيد ميلاد/وفاة أو مكلفة أطيان) من الخزينة، وملء البيانات بدقة وتسليمها لموظف الفرز المختص لتحديد القسم الإداري والدفتر.",
            ...
            },
            {
                ...
                "description_ar": "يقوم أمين الدفاتر بالبحث في المجلدات والقيود القديمة لاستخراج الأورنيك وتطابق رقم القيد والصفحة واسم المولود/المتوفى والمبلغ وتاريخ الواقعة.",
                ...
                "critical_tips": [
                    "في حال عدم العثور على القيد في السنة الأولى المحددة، يحق للباحث التمديد لسنة قبلها وسنة بعدها دون سداد رسوم جديدة."
                ]
            },
            {
                "step_number": 4,
                ...
                "description_ar": "تفريغ محتوى الدفتر التاريخي في شهادة رسمية بيضاء ممهورة ببيانات المجلد والصفحة، ومراجعتها وتوقيعها من مدير الإدارة، ثم ختمها بخاتم شعار الجمهورية (النسر).",
    ...
    },
    {
        ...
        "overview_ar": "المسار القانوني الإلزامي لتصديق المستندات والشهادات الصادرة من الجهات المصرية (أحوال مدنية، جامعات، تجارة وصناعة، عقود) للاعتداد بها رسمياً أمام الهيئات والجامعات والمحاكم الأجنبية.",
        ...
        "recommended_poa_text": "يوكل في تمثيلي أمام كافة مكاتب تصديقات وزارة الخارجية بجمهورية مصر العربية، وأمام كافة السفارات والقنصليات والممثليات الدبلوماسية الأجنبية المعتمدة في مصر، ومراكز خدمات التأشيرات والتوثيق (مثل VFS Global وغيرها)، وله حق تقديم المحررات الرسمية والشهادات وتصديقها ودفع الرسوم واستلامها.",
        "steps": [
            {
                "step_number": 1,
                "title_ar": "توثيق الجهة المصدرة للمستند (جهة المنشأ)",
                "title_en": "Origin Authority Certification",
                "location": "الجهة المصدرة المختصة (قطاع الأحوال المدنية بالعباسية / الإدارة المركزية للجامعات / وزارة العدل)",
                "department": "إدارة التصديقات والمراجعة بالوزارة المعنية",
                "description_ar": "يجب أن يختم المستند أولاً من الإدارة العامة التابعة لها الجهة المصدرة (مثلاً: شهادات الميلاد تصدق من الأحوال المدنية بالعباسية، الشهادات الجامعية من أمين الجامعة وأمين المجلس الأعلى، التوكيلات من أمين الشهر العقاري).",
                "description_en": "The original document must first bear the seal of its governing central authority (e.g. Civil Status Authority HQ, Supreme Council of Universities, Ministry of Justice).",
                "required_documents": [
                ...
                "critical_tips": [
                    "تأكد من وضوح اسم وتوقيع الموظف المعتمد لدى وزارة الخارجية، حيث توجد نماذج توقيعات معتمدة مخزنة لدى الخارجية."
                ]
            },
            {
                "step_number": 2,
                ...
                "location": "أحد مكاتب تصديقات الخارجية (أحمد عرابي بالمهندسين / الميريلاند بمصر الجديدة / سان ستيفانو بالإسكندرية)",
                "department": "مكتب تصديقات المواطنين",
                "description_ar": "فحص المستند ومطابقة خاتم الجهة المصدرة بنموذج التوقيع المعتمد، ووضع طابع تصديقات وزارة الخارجية وختمها الرسمي.",
                ...
                "critical_tips": [
                    "التأكد من دفع الرسوم عبر الدفع الإلكتروني (فيزا / ماستركارد / ميزة) حيث تم إلغاء التعامل النقدي تماماً."
                ]
            },
            {
                "step_number": 3,
                ...
                "description_ar": "ترجمة المستند الموثق من الخارجية بالكامل (بما في ذلك الأختام والأرقام المسلسلة) عبر مترجم أو مكتب معتمد ومقبول لدى سفارة الدولة الأجنبية.",
                ...
                "critical_tips": [
                    "راجع قائمة المكاتب المعتمدة المنشورة رسمياً على موقع السفارة (مثل سفارة قبرص، هولندا، ألمانيا) لتجنب رفض الترجمة."
                ]
            },
            {
                "step_number": 4,
                ...
                "description_ar": "حجز موعد مسبق عبر المنظومة الإلكترونية، وإيداع الأصول والمترجمات وسداد الرسوم القنصلية المحددة واستلام المستند المصدق دولياً.",
    ...
    },
    {
        ...
        "overview_ar": "المسار الإجرائي والقانوني الكامل لتعديل الشكل القانوني لشركة أشخاص (تضامن أو توصية بسيطة) وتحويلها إلى شركة أموال (مساهمة مصرية أو ذات مسؤولية محدودة) للاستفادة من المزايا الائتمانية وحوافز قانون الاستثمار.",
        ...
        "recommended_poa_text": "يوكل في تمثيلي أمام الهيئة العامة للاستثمار والمناطق الحرة، ومصلحة السجل التجاري، والغرفة التجارية، ومصلحة الضرائب، وله حق تقديم طلبات تعديل وتوفيق الشكل القانوني للشركة، واعتماد تقارير تقييم الحصص العينية، والتوقيع على عقود التعديل أمام الشهر العقاري، واستلام السجلات التجارية والتراخيص المعدلة.",
        "steps": [
            {
                "step_number": 1,
                ...
                "description_ar": "انعقاد جماعة الشركاء وصدور قرار بالإجماع على تعديل الشكل القانوني إلى شركة مساهمة، وتحديد رأس المال، وتعيين مراقب حسابات معتمد مقيد بسجل المحاسبين والمراجعين لإعداد الميزانية الافتتاحية وتقييم أصول وخصوم الشركة.",
                ...
                "critical_tips": [
                    "يشترط ألا يقل عدد مؤسسي الشركة المساهمة الناتجة عن 3 مساهمين، فإذا كان عدد الشركاء اثنين يجب إدخال مساهم ثالث في عقد التحول."
                ]
            },
            {
                "step_number": 2,
                ...
                "description_ar": "إعداد القوائم المالية وتقرير فحص المركز المالي للشركة القديمة معتمد من المحاسب القانوني، وتقديمه للجنة التحقق من صحة تقييم الحصص بالهيئة العامة للاستثمار.",
                ...
                "critical_tips": [
                    "احرص على ألا تقل صافي حقوق الملكية المقيمة عن الحد الأدنى لرأس المال المصدر للشركة المساهمة (250 ألف جنيه على الأقل)."
                ]
            },
            {
                "step_number": 3,
                ...
                "description_ar": "إيداع نموذج عقد التأسيس والنظام الأساسي للشركة المساهمة، وسداد رسوم الهيئة ورسوم نقابة المحامين، وصدور قرار رئيس الهيئة بالموافقة على تحويل الشكل القانوني ونشره بصحيفة الاستثمار.",
                ...
                "critical_tips": [
                    "إجراءات الشهر العقاري تتم داخل مكاتب الشهر العقاري النموذجية بمركز خدمات المستثمرين لتوفير الوقت."
                ]
            },
            {
                "step_number": 4,
                ...
                "description_ar": "التأشير في السجل التجاري بمحو القيد كشركة تضامن وإثبات القيد بالرقم الجديد كشركة مساهمة، ثم إخطار مأمورية الضرائب لتحديث البطاقة الضريبية وملف الفاتورة الإلكترونية.",
                ...
                "critical_tips": [
                    "استخرج 5 مستخرجات رسمية حديثة من السجل التجاري الجديد لتقديمها للجهات المصرفية والتأمينات والجمارك لتعديل المعاملات."
                ]
            }
        ]
    }

    {
        ...
        "statutory_basis": "قانون الأحوال المدنية رقم 143 لسنة 1994 وتعديلاته بالقانون رقم 140 لسنة 2022 والتعليمات المنظمة لسجلات قيد مواطني الخارج",
        "overview_ar": "الدليل الإجرائي الميداني لاستخراج بطاقة الرقم القومي لأول مرة للمواطنين المصريين المولودين خارج جمهورية مصر العربية، الحاصلين بالفعل على شهادة ميلاد مصرية مميكنة (ساقط قيد ساقط ميلاد خارج البلاد). يوضح الدليل شروط الحضور والضامن وإثبات محل الإقامة بالقاهرة الجديدة والمستندات والرسوم الرسمية لكافة فئات الاستمارات ومواقع المراكز النموذجية بالمولات.",
        "overview_en": "Step-by-step procedural guide for Egyptian citizens born overseas (with automated Egyptian birth certificates) issuing their first National ID in Egypt, focusing on New Cairo locations, VIP express options, and required proofs.",
        "recommended_poa_text": "يوكل في تمثيلي أمام قطاع مصلحة الأحوال المدنية وفروعها والمراكز النموذجية، وله حق سحب استمارات بطاقة الرقم القومي وملء البيانات وسداد الرسوم، واستلام بطاقة الرقم القومي ومحررات القيد المدني والتوقيع على الدفاتر الرسمية واستلام الإيصالات الرسمية.",
        "steps": [
            {
                "step_number": 1,
                ...
                "description_ar": "تجهيز أصل شهادة الميلاد المصرية المميكنة (الكمبيوتر) التي تحمل الرقم القومي المكون من 14 رقماً، وأصل جواز السفر البريطاني (أو الأجنبي) الساري، ومستند إثبات الإقامة داخل مصر (عقد إيجار موثق بالشهر العقاري أو إيصال مرافق كهرباء/غاز/مياه باسم الطالب أو أحد والديه)، وإثبات المهنة أو المؤهل (شهادة قيد دراسي مصدقة ومترجمة أو إثبات قيد جامعي بمصر أو الخارج)، وتجهيز ضامن من أقارب الدرجة الأولى (أب، أم، أخ، عم) يحمل بطاقة رقم قومي مصرية سارية المفعول.",
                "description_en": "Gather original automated Egyptian birth certificate (with 14-digit national ID), valid British passport, proof of residence in Egypt (utility bill or registered lease), education/profession certificate, and first-degree family guarantor with valid Egyptian ID.",
                "required_documents": [
                    ...
                    "مستند إثبات محل الإقامة (إيصال مرافق حديث كهرباء/غاز/مياه، أو عقد إيجار موثق بالشهر العقاري بالقاهرة الجديدة)",
                    "مستند إثبات المؤهل الدراسي أو جهة العمل (مصدق من الخارجية المصرية إذا كان صادراً من بريطانيا)"
                ],
                "poa_requirements": "استخراج البطاقة لأول مرة يلزم الحضور الشخصي لصاحب الشأن لالتقاط البصمة والصورة البيومترية، ويمكن للوكيل المساعدة في تجهيز وتدقيق الملف.",
                "estimated_duration": "يوم واحد",
                "official_fees": "بدون رسوم مسبقة",
                "critical_tips": [
                    "الضامن من الدرجة الأولى إلزامي قانوناً في استخراج بطاقة أول مرة ليوقع ويقر بالصلة أمام موظف السجل المدني.",
                    "إذا كانت الشهادة الدراسية بريطانية ولم تعادل أو تصدق بعد من الخارجية المصرية، تدون المهنة في الاستمارة 'حاصل على مؤهل كذا بالخارج' أو 'بدون عمل' تفادياً للتعطيل."
                ]
            },
            {
                "step_number": 2,
                ...
                "location": "المراكز النموذجية بالقاهرة الجديدة (مكسيم مول بالتجمع الخامس، سيتي سنتر ألماظة، أو سيتي ستارز)",
                "department": "صالة الخدمات المركزية للأحوال المدنية بالمول",
                "description_ar": "التوجه إلى أحد المراكز النموذجية المميكنة بالأحوال المدنية القريبة من القاهرة الجديدة. يُنصح بمول مكسيم (شارع التسعين الشمالي - التجمع الخامس) أو مول سيتي سنتر ألماظة أو سيتي ستارز، وشراء استمارة الرقم القومي المناسبة وفق الرغبة في سرعة الاستلام.",
                ...
                "official_fees": "فئات الاستمارة: الفئة العادية 50 ج.م (15 يوماً) | العاجلة 125 ج.م (3 أيام) | الخاصة 175 ج.م (24 ساعة) | VIP إكسبريس 515 ج.م (ساعتين) | الفورية 800 ج.م (استلام فوري)",
                "critical_tips": [
                    "المراكز النموذجية بالمولات تعمل فترات مسائية حتى الساعة 8-9 مساءً وتعمل أيام العطلات والجمعة، وهي الخيار الأسرع والأنسب تفادياً للزحام الحكومي التقليدي."
                ]
            },
            {
                "step_number": 3,
                ...
                "description_ar": "تفريغ البيانات في الاستمارة: الاسم الرباعي، اسم الأم، تاريخ ومحل الميلاد، الرقم القومي، الديانة، الحالة الاجتماعية، ومحل الإقامة. يقوم الضامن الحاضر بالتوقيع في خانة الضامن مع إرفاق صورة بطاقته ومطابقتها بالأصل.",
                ...
                "critical_tips": [
                    "تأكد من كتابة الاسم باللغة العربية مطابقاً تماماً لحروف شهادة الميلاد المصرية المميكنة دون أي اختلاف في الهمزات أو الألقاب."
                ]
            },
            {
                "step_number": 4,
                ...
                "description_ar": "التقاط البصمات العشرية إلكترونياً والصورة الشخصية الرقمية واستلام إيصال استلام البطاقة الموضح به الباركود وموعد التسليم (فورياً خلال ساعتين للـ VIP، أو في الموعد المحدد حسب فئة الاستمارة).",
                ...
                "critical_tips": [
                    "احتفظ بالإيصال الورقي المختوم، وتأكد فور استلام البطاقة من صحة الرقم القومي ومحل الإقامة والمهنة المدونة على الظهر."
                ]
            }
        ]
}
