document.addEventListener('DOMContentLoaded', () => {
    ...
    createCaseForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                alert('تعذر حفظ المعاملة. يرجى المحاولة مرة أخرى.');
            }
        } catch (err) {
    ...
    runOcrBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            alert('تعذر الاتصال بالخادم أثناء فحص الوثيقة.');
        } finally {
    ...
    async function loadRegulatoryUpdates(query = '') {
        try {
            ...
            regulatoryContainerEl.innerHTML = '<div class="empty-state">تعذر تحميل الرادار التنظيمي حاليًا.</div>';
        }
    }
